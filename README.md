...
<img src = './images/14visibility.png' width='400'><img src = './images/15windspeed.png' width='395'>
These are the other factors of weather itself. Most of the traffic accidents take place in the normal range of these factors. There are some interesting insights that could be derived from this. <p>&nbsp;</p>
